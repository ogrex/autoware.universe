  ...
  last_updated_time_(this->now())
{
  ...
  // Initialize processor
  {
    ...
    TrackerProcessorConfig config;
    {
      ...
      config.pruning_static_target_speed = declare_parameter<double>("pruning_static_target_speed");
      config.pruning_moving_target_speed = declare_parameter<double>("pruning_moving_target_speed");
