...
public:
  ...
  void setDiagnosticsInterface(autoware::universe_utils::DiagnosticsInterface* diag_ptr)
  {
...
private:
  ...
  autoware::universe_utils::DiagnosticsInterface* diagnostics_interface_ptr_{nullptr};
};
